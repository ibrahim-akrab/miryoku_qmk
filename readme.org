...
To flash to the kyboard use: ~qmk flash -c -kb crkbd -km manna-harbour_miryoku -bl avrdude-split-left~ and ~qmk flash -c -kb crkbd -km manna-harbour_miryoku -bl avrdude-split-right~ for left and right halves respectively.
